...
nnoremap <unique> <Leader>t :edit TODO.md<CR>
...
nnoremap <unique> ,gm :execute 'normal '.(virtcol('$')/2).'\|'<CR>
...
" вставка буфера выделения `Ctrl+Shift+Insert`, нет смысла для visual
...
tnoremap <unique> <A-0> <C-\><C-n>:execute "tabn ".g:LastTab<CR>
inoremap <unique> <A-0> <C-\><C-n>:execute "tabn ".g:LastTab<CR>
nnoremap <unique> <A-0> :execute "tabn ".g:LastTab<CR>

nnoremap <unique> ,` :terminal<CR>
nnoremap <unique> <C-t> :tabnew<CR>

nnoremap <unique> <C-w><A-h> :leftabove vnew<CR>
nnoremap <unique> <C-w><A-j> :rightbelow new<CR>
nnoremap <unique> <C-w><A-k> :leftabove new<CR>
nnoremap <unique> <C-w><A-l> :rightbelow vnew<CR>

nnoremap <unique> <C-w><A-H> :topleft vnew<CR>
nnoremap <unique> <C-w><A-J> :botright new<CR>
nnoremap <unique> <C-w><A-K> :topleft new<CR>
nnoremap <unique> <C-w><A-L> :botright vnew<CR>

nnoremap <unique> <C-w><A-+> :resize +10<CR>
nnoremap <unique> <C-w><A--> :resize -10<CR>
nnoremap <unique> <C-w><A-<> :vertical-resize +40<CR>
nnoremap <unique> <C-w><A->> :vertical-resize -40<CR>
...
" use `,` prefix, `Alt+Shift+4` - bad keyboard key
nnoremap <silent><unique> ,<A-1> :CtrlSpace K q<CR>
nnoremap <silent><unique> ,<A-2> :CtrlSpace Kj q<CR>
nnoremap <silent><unique> ,<A-3> :CtrlSpace Kjj q<CR>
nnoremap <silent><unique> ,<A-4> :CtrlSpace Kjjj q<CR>
nnoremap <silent><unique> ,<A-5> :CtrlSpace Kjjjj q<CR>
nnoremap <silent><unique> ,<A-6> :CtrlSpace Kjjjjj q<CR>
nnoremap <silent><unique> ,<A-7> :CtrlSpace Kjjjjjj q<CR>
nnoremap <silent><unique> ,<A-8> :CtrlSpace Kjjjjjjj q<CR>
nnoremap <silent><unique> ,<A-9> :CtrlSpace J q<CR>
nnoremap <unique> ,<A-0> <C-^>

" plugin:unimpaired {{{
" TODO
" nnoremap <silent><unique> [s :CtrlSpace k q<CR>
" nnoremap <silent><unique> [S :CtrlSpace K q<CR>
" nnoremap <silent><unique> ]s :CtrlSpace j q<CR>
" nnoremap <silent><unique> ]S :CtrlSpace J q<CR>
" }}}

" plugin:bclose {{{
nnoremap <silent><unique> ,bd :Bclose<CR>
nnoremap <silent><unique> ,bf :CtrlSpace fq<CR>
nnoremap <silent><unique> ,bF :CtrlSpace Fq<CR>
" }}}
" }}}
...
" nnoremap <silent><unique> ,bm  :BufMRUCommit<CR>
" }}}
" }}}
...
nnoremap <unique> [oC :<C-u>call css_color#enable()<CR>
" css, color, disable | выключить css цвета')
nnoremap <unique> ]oC :<C-u>call css_color#disable()<CR>
" css, color, toggle | переключить css цвета')
nnoremap <unique> yoC :<C-u>call css_color#toggle()<CR>
" }}}
" }}}

" plugin:unimpaired {{{
" TODO
" nnoremap <unique> [oN :setlocal nonumber relativenumber signcolumn=number<CR>
" nnoremap <unique> ]oN :setlocal number norelativenumber signcolumn=auto<CR>
" " https://stackoverflow.com/questions/18319284/vim-sign-column-toggle
" nnoremap <unique> yoN :setlocal number! relativenumber! \| execute "set signcolumn=" .. (&signcolumn == "number" ? "auto" : "number")<CR>
...
" plugin:windowswap {{{
nnoremap <silent><unique> ,w :call WindowSwap#EasyWindowSwap()<CR>
" }}}
...
nnoremap <unique> ,gf :edit <cfile><CR>
nnoremap <unique> ,<C-W>f :split <cfile><CR>
nnoremap <unique> ,<C-W><C-f> :vsplit <cfile><CR>
nnoremap <unique> ,<C-W>gf :tabe <cfile><CR>
